...
public class AppUtil {
	  ...
	  * @return  字符串
	  */
	public static String toPrint(int code,String msg,Object obj,JsonConfig config){
		 
		 //大小写不影响
		 String str="";
		 str=toJsonString(code, msg, obj,config);			 
		 return str;
	 }
	...
	public static String toJsonArray(int code,String msg,Object obj){
	  ...
	  * @return json对象 字符串
	  */
	 private static String toJsonString(int code,String msg,Object obj,JsonConfig config){
	  ...
	  * @return xml数据
	  */
	 private static String toXml(int code,String msg,Object obj,JsonConfig config){
	  ...
	  * @return
	  */
	public static Map<String, Object> toKeyVal(int code,String msg,Object obj){
